...
void Player::updatePosition()
{
    ...
    if(this->animation->getIsRunning())
    {
        this->animation->setPos(xPlayer, yPlayer - RUN_SPRITE_HEIGHT + TILE_SIZE -1);
        this->spritePosition = {xPlayer,yPlayer - RUN_SPRITE_HEIGHT + TILE_SIZE -1};
    }
    else
    {
        this->animation->setPos(xPlayer, yPlayer - WALK_SPRITE_HEIGHT + TILE_SIZE -1);
        this->spritePosition = {xPlayer,yPlayer - WALK_SPRITE_HEIGHT + TILE_SIZE -1};
    }
    emit playerMoved();
}
